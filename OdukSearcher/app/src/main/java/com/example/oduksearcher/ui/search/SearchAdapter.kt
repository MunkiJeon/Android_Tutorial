...
import com.example.oduksearcher.databinding.ItemLoadingBinding
import com.example.oduksearcher.databinding.ItemSearchResultBinding
import com.example.oduksearcher.ui.ListItem
import com.example.oduksearcher.util.toFormattedDatetime
...
class SearchAdapter(private val onClick: (ListItem) -> Unit) :
    ...
    class ImageViewHolder(
        ...
        private val thumbnailImageView = binding.resIvThumbnail
        private val siteNameTextView = binding.resTvSiteName
        private val datetimeTextView = binding.resTvTimestamp
